...
import { Search, Filter, TrendingUp, Globe, Zap, Trophy, Coins, Briefcase, TrendingDown, Flame, Award, Target, Circle, Disc, Loader2, RefreshCw } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-shrink-0 bg-[var(--bg-primary)] border-b border-[var(--border-color)]">
        ...
        <div className="px-4 pt-4 pb-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 bg-emerald-500/10 px-2 py-1 rounded-full border border-emerald-500/30">
            <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div>
            <span className="text-emerald-500 text-[10px] font-medium uppercase tracking-wider">Live</span>
          </div>
        </div>
        ...
        <div className="flex gap-2 px-4 pb-3">
          ...
          <button 
            ...
            disabled={loading}
            className="bg-[var(--hover-bg)] hover:bg-[var(--active-bg)] disabled:opacity-50 disabled:cursor-not-allowed px-3 py-2 rounded-xl transition-all"
